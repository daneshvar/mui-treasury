...
export default (() => {
  ...
  return {
    ...
    setSecondaryAutoCollapseDisabled: createSet(config, 'secondaryAutoCollapseDisabled'),
    setSecondaryCollapseBreakpoint: createSet(config, 'secondaryCollapseBreakpoint'),
    ...
    setSecondaryInsetHiddenBreakpoint: createSet(config, 'secondaryInsetHiddenBreakpoint'),
    setSecondaryInsetHiddenDisabled: createSet(config, 'secondaryInsetHiddenDisabled')
  };
});