...
const fontFamily = ['-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Roboto', '"Helvetica Neue"', 'Arial', 'sans-serif', '"Apple Color Emoji"', '"Segoe UI Emoji"', '"Segoe UI Symbol"'].join(',');
const helperTextColor = '#6c757d';
const validColor = '#28a745';
const errorColor = '#dc3545';
const helperTextFontSize = 12.8;
export const bootstrapLabelStyles = ({
  palette,
  spacing
}) => {
...
export const bootstrapHelperTextStyles = ({
  spacing
}) => {
  const space = spacing(1); // default = 8;
